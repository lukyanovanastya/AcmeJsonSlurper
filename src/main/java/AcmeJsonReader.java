...
public class AcmeJsonReader {

    AcmeJsonPath<AcmeJsonPath.Element> jpath;
    AcmeJsonHandler handler;

    public AcmeJsonReader(AcmeJsonHandler handler){
        this.handler=handler;
        jpath = new AcmeJsonPath<AcmeJsonPath.Element>();
    }
